...
export type CreateUnfollowTypedDataMutationVariables = Exact<{ [key: string]: never; }>;
...
export const useCreateUnfollowTypedDataMutation = <
    ...
    useMutation<CreateUnfollowTypedDataMutation, TError, CreateUnfollowTypedDataMutationVariables, TContext>(
      ...
      (variables?: CreateUnfollowTypedDataMutationVariables) => fetcher<CreateUnfollowTypedDataMutation, CreateUnfollowTypedDataMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, CreateUnfollowTypedDataDocument, variables)(),
      options
    );
